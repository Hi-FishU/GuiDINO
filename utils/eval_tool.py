...
def compute_location_per_level(height, width, stride, device):
    ...
    # It is the center location of the anchor

    return location


def compute_location(features: torch.Tensor, strides: list):
    locations = []

    for i, feat in enumerate(features):
        _, _, height, width = feat.shape
        location_per_level = compute_location_per_level(
            height, width, strides[i], feat.device
        )
